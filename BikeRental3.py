...
class BikeRental:
    ...
    def rentBikeOnHourlyBasis(self, n):
        ...
        if n <= 0:
            ...
            print("You will be charged 5 euros for each hour per bike.")
    ...
    def rentBikeOnDailyBasis(self, n):
        ...
        if n <= 0:
            ...
            print("You will be charged 20 euros for each day per bike.")
            print("We hope that you enjoy our service.")
    ...
    def rentBikeOnWeeklyBasis(self, n):
        ...
        if n <= 0:
            ...
            print("You will be charged 60 euros for each week per bike.")
            print("We hope that you enjoy our service.")
            self.stock -= n
...
def main():
    ...
    while True:
        ...
        2. Request a bike on an hourly basis - 3 euros
